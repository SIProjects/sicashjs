import { SICashRPCRaw } from "./SICashRPCRaw"
...
/**
 * Transaction receipt returned by sicashd
 */
...
/**
 * The raw log data returned by sicashd, not ABI decoded.
 */
...
export class SICashRPC extends SICashRPCRaw {
